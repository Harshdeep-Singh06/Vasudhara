...
const AboutCards = () => {
  return (
    // Debugging try 1
    <div className='bg-gradient-to-r from-[#1b2a21] via-[#344f3f] to-[#1b2a21] py-16 px-6'>
        ...
        <div className='flex gap-6 flex-wrap justify-center items-stretch'>
            <div className='flex flex-col w-full   sm:w-[47%] lg:w-[23%] rounded-xl overflow-hidden bg-[#2a1515] hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-2xl'>
