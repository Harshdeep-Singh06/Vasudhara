...
const AboutCards = () => {
  return (
    // Debugging try 1
    <div className='bg-gradient-to-b from-[#2f3a2c] via-[#41493e] to-[#f5f5f5] py-16 px-6'>
        ...
        <div className='flex gap-6 flex-wrap justify-center items-stretch'>
            <div className='flex flex-col w-full   sm:w-[47%] lg:w-[23%] rounded-xl overflow-hidden bg-[#3b1f1f] hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-2xl'>
                <img src="/card-1.avif" alt="" className='w-full   aspect-[4/3] object-cover'/>
                <div className='bg-[#3b1f1f] text-white  p-6 flex flex-col flex-grow min-h-[200px]'>
            ...
            <div className='flex flex-col w-full  sm:w-[47%] lg:w-[23%]   rounded-xl overflow-hidden hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-2xl'>
                <img src="/card-2.avif" alt="" className='w-full  aspect-[4/3] object-cover'/>
                <div className='bg-[#3b1f1f] text-white p-6 flex flex-col flex-grow min-h-[200px]'>
            ...
            <div className='sm:w-[47%] lg:w-[23%]  w-full rounded-xl overflow-hidden flex-col flex hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-2xl'>
                <img src="/card-4.avif" alt="" className='w-full h-56  object-cover'/>
                <div className='bg-[#2a1515] text-white p-6 flex flex-col flex-grow min-h-[200px]'>
