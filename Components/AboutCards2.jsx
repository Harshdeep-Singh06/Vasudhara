...
const AboutCards2 = () => {
  ...
  return (
    ...
    <div className='lg:pb-5 pb-0 pt-6 flex flex-col lg:flex-row items-center px-4 sm:px-8 lg:px-16 bg-gradient-to-b from-[#d5b687] via-[#dfcdaf] to-[#efe3cc]'>
        ...
        <div>
        <div className='mt-10 leading-tight text-4xl  lg:text-6xl   font-semibold  text-[#26351f]/50 ml-10 lg:ml-0 font- '>
          ...
          <button
            onClick={() => scroll('left')}
            className="w-12 h-12 lg:w-14 lg:h-14  rounded-full border-2 border-black/30 flex items-center justify-center hover:bg-black hover:text-white transition-all duration-300 ml-37 lg:ml-20"
          >
            <ChevronLeft size={22} />
          </button>
