  ...
  return (
    <div className="overflow-x-hidden bg-white px-4 md:px-15 py-5">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center md:mt-4 gap-4">
        <p className="text-xl md:text-4xl text-[#26351f] font-semibold pl-11 mt-3 md:mt-0 md:pl-0 md:text-center md:text-left">
          LATEST NEWS AND HIGHLIGHTS
        </p>

        <div className="flex gap-3 pl-35 md:pl-0 translate-y-7 md:translate-y-0">
          <button
            onClick={() => scroll('left')}
